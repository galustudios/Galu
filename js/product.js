window.PRODUCTS = {
  ...
  "06": { name: "No. 06", comingSoon: true, image: "linear-gradient(135deg, #0d0d0d, #1a1a2e)" },
  "07": { name: "No. 07", comingSoon: true, image: "linear-gradient(135deg, #1b2838, #0f1923)" },
  "08": { name: "No. 08", comingSoon: true, image: "linear-gradient(135deg, #1d1d2e, #2a2a3e)" }
};